package com.yangxianwen.post176.resolver;
...
public class BarcodeScannerResolver {
    ...
    private final StringBuilder mResult = new StringBuilder();//扫码内容

    private OnScanSuccessListener mOnScanSuccessListener;
    private final Handler mHandler = new Handler();

    private final Runnable mScanningEndRunnable = this::performScanSuccess;
    ...
    //key事件处理
    public boolean resolveKeyEvent(KeyEvent event) {
